...
import PasswordForm, { type IPasswordFormSchema } from "@/components/forms/password.form"
...
const PasswordPage = () => {
	...
	return (
		<div className="px-3 lg:px-8">
			<Tabs defaultValue="all" className="w-full flex-col justify-start mt-4">
				<div className="flex items-center justify-between">
					...
					<TabsList className="hidden lg:flex **:data-[slot=badge]:size-5 **:data-[slot=badge]:rounded-full **:data-[slot=badge]:bg-muted-foreground/30 **:data-[slot=badge]:px-1">
						...
						<TabsTrigger value="social">
							<MessageCircleHeart />
							Social Media <Badge variant="secondary">3</Badge>
						</TabsTrigger>
						<TabsTrigger value="banks">
							<Landmark />
							Banks <Badge variant="secondary">2</Badge>
						</TabsTrigger>
						<TabsTrigger value="work">
							<BriefcaseBusiness />
							Work <Badge variant="secondary">10</Badge>
						</TabsTrigger>
						<TabsTrigger value="games">
							<Gamepad2 />
							Games <Badge variant="secondary">10</Badge>
						</TabsTrigger>
						<TabsTrigger value="general">
							<BookMarked />
							General <Badge variant="secondary">2</Badge>
						</TabsTrigger>
					</TabsList>
					<div className="flex items-center gap-2">
						<Drawer open={openDrawer} onOpenChange={setOpenDrawer}>
							...
							<DrawerContent>
								...
								<PasswordForm onRefresh={handleData} />
							</DrawerContent>
						</Drawer>
					</div>
				</div>
